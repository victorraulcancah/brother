...
class AuthService {
  ...
  Future<LoginResponse> register(String name, String email, String password, String passwordConfirmation, {int? empresaId}) async {
    ...
    final data = await _api.post('/register', body: body);
    await _api.saveToken(data['access_token']);
    return LoginResponse.fromJson(data);
  }
